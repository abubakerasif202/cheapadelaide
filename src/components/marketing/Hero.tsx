...
export function Hero({
  ...
  description = "Straightforward moving services for homes, apartments, offices, and furniture across Greater Adelaide. Transparent rates from $79 per 30 minutes with zero hidden stair surcharges.",
  imageSrc = "/brand/hero-truck.webp",
  imageAlt = "Branded removal truck on an Adelaide road",
  caption = "Adelaide Metro & Regional SA",
  facts = [
    business.location.fullAddress,
    `${business.hours} (Monday – Sunday)`,
    "Direct phone dispatch with zero automated bot delays",
  ],
  illustrative = true,
  showRates = true,
}: HeroProps) {
